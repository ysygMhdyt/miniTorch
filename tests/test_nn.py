...
def test_max(t: Tensor) -> None:
    ...
    minitorch.grad_check(lambda t: minitorch.max(t, 0), t + minitorch.rand(t.shape))
    minitorch.grad_check(lambda t: minitorch.max(t, 1), t + minitorch.rand(t.shape))
    minitorch.grad_check(lambda t: minitorch.max(t, 2), t + minitorch.rand(t.shape))
